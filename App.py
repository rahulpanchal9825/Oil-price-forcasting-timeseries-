...
st.set_page_config(page_title= "Oil Prices Forcasting Mechine learning App",layout = "wide")
st.title('Oil Prices Forcasting Mechine learning App')
image = mp.imread('D:\DATA SCIENCE\LMS\PROJECT\oil price forcast\Background.jpg')
st.image(image)
